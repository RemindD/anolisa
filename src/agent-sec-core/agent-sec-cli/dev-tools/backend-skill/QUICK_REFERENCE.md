...
my_parser = subparsers.add_parser("my_scanner", help="My scanner description")
my_parser.add_argument("--param1", default="", help="Parameter 1")
my_parser.add_argument("--verbose", action="store_true", help="Verbose output")
```
