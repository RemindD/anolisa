...
from security_middleware import _detect_caller, invoke
...
class TestInvoke(unittest.TestCase):
    @patch("security_middleware.router.get_backend")
    @patch("security_middleware.lifecycle.post_action")
    @patch("security_middleware.lifecycle.pre_action")
    ...
    @patch("security_middleware.router.get_backend")
    @patch("security_middleware.lifecycle.on_error")
    @patch("security_middleware.lifecycle.pre_action")
