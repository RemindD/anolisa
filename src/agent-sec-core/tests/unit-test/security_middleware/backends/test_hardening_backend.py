...
from security_middleware.backends.hardening import (
    HardeningBackend,
    _strip_ansi,
)
...
\x1b[33m[WARN  14:30:01]\x1b[0m engine.lua:186: [1.1.3] FAIL: Ensure mounting of udf is disabled
\x1b[33m[WARN  14:30:02]\x1b[0m engine.lua:186: [2.1.1] FAIL: Ensure time sync is enabled
\x1b[32m[INFO  14:30:03]\x1b[0m engine.lua:292: [5.1.1] MANUAL: No reinforce steps for audit rules
...
\x1b[31m[ERROR 14:30:04]\x1b[0m engine.lua:307: [3.2.1] FAILED-TO-FIX: Cannot set file permissions on /etc/shadow
\x1b[31m[ERROR 14:30:04]\x1b[0m engine.lua:295: [6.1.1] ENFORCE-ERROR: Failed to apply sysctl setting
...
LOONGSHIELD_DRYRUN = """\
\x1b[32m[INFO  14:30:01]\x1b[0m engine.lua:298: [1.1.3] DRY-RUN: would apply cramfs blacklist
\x1b[32m[INFO  14:30:02]\x1b[0m engine.lua:298: [2.1.1] DRY-RUN: would enable chronyd
...
class TestHardeningExecute(unittest.TestCase):
    ...
    def test_with_failures(self, mock_run):
        ...
        # 2 FAIL + 1 MANUAL = 3 failure entries
