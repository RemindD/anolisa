...
_REGISTRY: Dict[str, str] = {
    "sandbox_prehook": "security_middleware.backends.sandbox",
    "harden":          "security_middleware.backends.hardening",
    "verify":          "security_middleware.backends.asset_verify",
    "summary":         "security_middleware.backends.summary",
}
