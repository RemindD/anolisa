...
file-deletion Adapter. It deliberately contains no daemon process, persistence
implementation, Policy engine, PAP, Policy runtime, or target Client.
...
to later work packages and are intentionally absent from this workspace slice.
