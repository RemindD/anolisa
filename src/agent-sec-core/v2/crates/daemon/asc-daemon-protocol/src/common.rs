...
/// Generic current-resource identity parameters.
...
/// Generic resource identity plus immutable revision parameters.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
...
/// Bounded client-maintained pagination parameters.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct ListParams {
    /// Page size in the inclusive range 1..=1000.
    pub limit: u32,
    /// Client-maintained page offset.
    pub offset: u32,
}
...
/// Method result carrying one bounded page and its unpaginated total.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
