...
identifier!(BindingId, "Stable binding identifier.");
identifier!(ExecutionDomainId, "Trusted execution-domain identifier.");
...
identifier!(BaselineId, "Immutable runtime baseline identifier.");
identifier!(
    OperationId,
    "Globally unique reconcile operation identifier."
);
identifier!(RunId, "Trusted runtime-registry run identifier.");
identifier!(ReceiptId, "Globally unique receipt identifier.");
identifier!(
    PepInstanceId,
    "Stable identity of one enforcement-point instance."
);
identifier!(
    AgentSightInstanceId,
    "Stable identity of one `AgentSight` instance."
);
identifier!(
    TargetId,
    "Stable identity of one target enforcement backend."
);
